...
export const findWarehouseByIdController = async (
    req: Request,
    res: Response
): Promise<void> => {
    try {
        ...
        res.status(500).json({
            error: `Failed to find warehouse by ID: ${error.message}`,
        });
    }
};

export const findAllWarehousesController = async (
    req: Request,
    res: Response
): Promise<void> => {
    try {
        ...
        res.status(500).json({
            error: `Failed to find all warehouses: ${error.message}`,
        });
    }
};
...
export const updateWarehouseController = async (
    ...
    try {
        ...
        res.status(500).json({
            error: `Failed to update warehouse: ${error.message}`,
        });
    }
};
...
export const deleteWarehouseController = async (
    ...
    try {
        ...
        res.status(500).json({
            error: `Failed to delete warehouse: ${error.message}`,
        });
    }
};

export const findWarehousesByCityController = async (
    req: Request,
    res: Response
): Promise<void> => {
    try {
        ...
        res.status(500).json({
            error: `Failed to find warehouses by city: ${error.message}`,
        });
    }
};

export const updateWarehouseStockController = async (
    req: Request,
    res: Response
): Promise<void> => {
    try {
        ...
        const warehouse = await updateWarehouseStockService(
            id,
            stockUpdates,
            type
        );
        ...
        res.status(500).json({
            error: `Failed to update warehouse stock: ${error.message}`,
        });
    }
};

export const getLastIndexWarehouseController = async (
    req: Request,
    res: Response
): Promise<void> => {
    try {
        ...
        res.status(500).json({
            error: `Failed to get last index warehouse: ${error.message}`,
        });
    }
};
